...
public class AnnotatorSerializer implements JsonSerializer<Annotator> {
    @Override
    public JsonElement serialize(Annotator src, Type typeOfSrc, JsonSerializationContext context) {
