...
public class CompetitionSerializer implements JsonSerializer<Competition> {
    @Override
    public JsonElement serialize(Competition src, Type typeOfSrc, JsonSerializationContext context) {
