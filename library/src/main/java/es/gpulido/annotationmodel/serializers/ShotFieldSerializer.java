...
public class ShotFieldSerializer implements JsonSerializer<ShotField> {
    @Override
    public JsonElement serialize(ShotField src, Type typeOfSrc, JsonSerializationContext context) {
